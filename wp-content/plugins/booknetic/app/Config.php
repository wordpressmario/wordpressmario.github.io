...
class Config
{
	...
	public static function load()
	{
        ...
        if (
            in_array('elementor/elementor.php',
                apply_filters(
                    'active_plugins', get_option( 'active_plugins' )
                ))) {
            add_action( 'elementor/widgets/register', [self::class, 'register_booknetic_elementor'] );
        }
	}
    ...
    public static function register_booknetic_elementor( $widgets_manager ) {

        $widgets_manager->register( new BookneticElementor() );
    }
