...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="input_name" value="<?php echo htmlspecialchars($parameters['staff']['name'])?>">
    </div>

    <div class="form-group col-md-6">
        <label for="input_name"><?php echo bkntc__('Profession')?></label>
        <input type="text" class="form-control" id="input_profession" value="<?php echo htmlspecialchars($parameters['staff']['profession'])?>">
    </div>
</div>
...
<?php if (\BookneticApp\Providers\Core\Capabilities::tenantCan('locations')) : ?>
<div class="form-row">
    <div class="form-group col-md-12">
