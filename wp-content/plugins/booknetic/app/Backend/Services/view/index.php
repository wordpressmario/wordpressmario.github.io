...
function printTree( $parentId, &$categories, &$staff, $class = 'vertical' )
{
	...
	foreach ( $categories[ $parentId ] AS $categId => $categInf )
	{
		...
		{
			$return .= printTree( $categId, $categories, $staff, $categInf['class'] );
		}
	...
	<div id="categories_tree">
		<ul>
			<li data-type="root" data-id="0">
				...
				<?php echo printTree(0, $parameters['categories'], $parameters['staff'])?>
			</li>
		</ul>
	</div>
