					...
					<div class="booknetic_appointment" id="booknetic_theme_<?php echo $parameters['id']?>">
						<div class="booknetic_appointment_steps" data-change-for="panel" data-type="background-color">
							<div class="booknetic_appointment_steps_body">
								<div class="booknetic_appointment_step_element booknetic_selected_step"><span class="booknetic_badge" data-change-for="compleated_steps" data-type="background-color">1</span> <span class="booknetic_step_title" data-change-for="compleated_steps_txt" data-type="color"> <?php echo bkntc__('Location')?></span></div>
								<div class="booknetic_appointment_step_element booknetic_selected_step"><span class="booknetic_badge" data-change-for="compleated_steps" data-type="background-color">2</span> <span class="booknetic_step_title" data-change-for="compleated_steps_txt" data-type="color"> <?php echo bkntc__('Staff')?></span></div>
