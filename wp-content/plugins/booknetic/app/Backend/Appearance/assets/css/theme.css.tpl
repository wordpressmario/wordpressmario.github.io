...
#booknetic_theme_%%id%% .booknetic_btn_primary, #booknetic_theme_%%id%% .booknetic_selected_time, #booknetic_theme_%%id%%   .booknetic_calendar_selected_day > div
{
...
#booknetic_theme_%%id%% .booknetic_service_card_selected, #booknetic_theme_%%id%% .booknetic_card_selected, #booknetic_theme_%%id%% .booknetic_service_extra_card_selected, #booknetic_theme_%%id%% .booknetic_payment_method_selected
{
    border-color: %%border%% !important;
}

#booknetic_theme_%%id%% .booknetic_service_card_price, #booknetic_theme_%%id%% .booknetic_service_extra_card_price, #booknetic_theme_%%id%% .booknetic_confirm_details_price:not([data-price-id="discount"] .booknetic_confirm_details_price,.booknetic_gift_discount_price)
{
