	...
	<div class="form-row break_line<?php echo $display?'':' hidden'?>">
		<div class="form-group col-md-9">
			...
			<div class="input-group">
				...
				<div class="col-md-6 p-0 m-0"><select class="form-control break_end" placeholder="<?php echo bkntc__('Break end')?>"><option selected><?php echo ! empty( $end ) ? Date::time( $end ) : ''; ?></option></select></div>
			</div>
		</div>
