		...
		<div class="ms-content">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input class="form-control" id="input_company_name" value="<?php echo htmlspecialchars( Helper::getOption('company_name', '') )?>">
				</div>
				<div class="form-group col-md-6">
					<label for="input_company_address"><?php echo bkntc__('Address')?>:</label>
					<input class="form-control" id="input_company_address" value="<?php echo htmlspecialchars( Helper::getOption('company_address', '') )?>">
				</div>
			</div>
