...
<div class="form-row">
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" id="input_location_name" value="<?php echo htmlspecialchars($parameters['location']['name'])?>">
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" id="input_address" value="<?php echo htmlspecialchars($parameters['location']['address'])?>">
        <div id="divmap"></div>
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-12">
        ...
        <textarea id="input_note" class="form-control"><?php echo htmlspecialchars($parameters['location']['notes'])?></textarea>
    </div>
</div>