(function ($) {
        ...
        let keywordButton = function (context) {
            ...
            let button = ui.buttonGroup([
                ui.button({
                    ...
                    contents: '<span class="fa fa-info"></span> Keywords <span class="note-icon-caret"></span>',
                    data: {
                        toggle: 'dropdown'
                    },
                    click:  () => {
    ...
    booknetic.checkShortCodes = function(node) {
        ...
        if ( !!node.match(regex) ) {
            ...
            return node.replace(regex, function(rawData, dataWithProtocol, dataWithShortCode) {

                return dataWithShortCode;
